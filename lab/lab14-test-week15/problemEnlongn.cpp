/*
 * @Author: Frank Chu
 * @Date: 2022-12-12 09:03:43
 * @LastEditors: Frank Chu
 * @LastEditTime: 2022-12-12 09:37:59
 * @FilePath: /Cpp/lab/lab14-test-week15/problemEnlongn.cpp
 * @Description: 
 * 
...
int main() {
    ...
    BubbleSortWithReversals solver;
    cout << solver.getMinSwaps(A, k) << endl;
    return 0;
}